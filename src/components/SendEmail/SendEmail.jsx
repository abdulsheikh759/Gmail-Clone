...
const SendEmail = () => {
    ...
    return (
        <div className={`${open ? 'block' : 'hidden'} bg-white max-w-6xl shadow-xl shadow-slate-600 rounded-t-md`}>
            <div className='flex px-3 py-2 bg-[#F2F6c] justify-between rounded-t-md'>
                <h1>New Message</h1>
            ...
            <form onSubmit={submitHandler} className='flex flex-col p-3 gap-2'>
                ...
                <button type='submit' className='rounded-full w-fit px-4 py-2 text-white font-medium bg-[#297BE6]  cursor-pointer' >Send</button>
            </form>
        </div>
    )
}
